...
<main>
    <section id="evening-banner" class="-mt-28 border-b-4 border-primary-NORMAL border-solid flex items-center justify-center" data-pg-ia-scene="{&quot;l&quot;:[{&quot;t&quot;:&quot;div&quot;,&quot;p&quot;:&quot;time&quot;,&quot;a&quot;:{&quot;l&quot;:[{&quot;t&quot;:&quot;&quot;,&quot;l&quot;:[{&quot;t&quot;:&quot;set&quot;,&quot;p&quot;:0.5,&quot;d&quot;:0,&quot;l&quot;:{&quot;autoAlpha&quot;:0,&quot;y&quot;:&quot;100%&quot;},&quot;e&quot;:&quot;Power1.easeOut&quot;},{&quot;t&quot;:&quot;tween&quot;,&quot;p&quot;:0.5,&quot;d&quot;:0.5,&quot;l&quot;:{&quot;autoAlpha&quot;:1,&quot;y&quot;:&quot;0%&quot;},&quot;e&quot;:&quot;Power1.easeOut&quot;}]}]}}]}">
        <div class="flex justify-center text-center text-gray-200 w-full" data-pg-ia-hide>
            <h1 class="flex font-medium font-sans lowercase text-5xl text-center translate-y-12 sm:text-6xl md:text-6xl lg:text-6xl xl:text-7xl 2xl:text-7xl"><?php _e( 'evening menu', 'mossco_hc' ); ?></h1>
        </div>
    </section>
    <section id="mossco-menu-col" class="container flex flex-wrap font-sans max-w-screen-xl mx-auto px-4 py-14">
        <div class="gap-2 grid grid-cols-1 md:gap-10 md:grid-cols-2">
            <div class="col-span-1">
                <h3 class="text-3xl text-primary-NORMAL"><?php _e( 'EVENING Menu', 'mossco_hc' ); ?></h3>
                <h4 class="border-b-2 border-primary-NORMAL border-solid mb-6 mt-2 pb-2 text-xl md:mb-6"><?php _e( 'Small Plates', 'mossco_hc' ); ?></h4> 
                <div class="menu_item">
                    <dt><?php _e( 'Crispy chicken wings', 'mossco_hc' ); ?></dt>
                    <dd>
                        <?php _e( 'Smokey BBQ, soy honey &amp; sesame, Louisiana hot sauce, roast garlic &amp; parmesan', 'mossco_hc' ); ?>
                    </dd>
                    <p class="allergen_info"><?php _e( '(2,10,11,4)', 'mossco_hc' ); ?></p>
                    <p class="price"><?php _e( '&euro;7.50', 'mossco_hc' ); ?></p>
                </div>
                <div class="menu_item">
                    <dt><?php _e( 'Hearty minestrone soup', 'mossco_hc' ); ?></dt>
                    <dd>
                        <?php _e( 'Seasonal veg, orzo pasta, cannellini beans &amp; fresh basil', 'mossco_hc' ); ?>
                    </dd>
                    <p class="allergen_info"><?php _e( '(1,2,10,4)', 'mossco_hc' ); ?></p>
                    <p class="price"><?php _e( '&euro;7.50', 'mossco_hc' ); ?></p>
                </div>
                <div class="menu_item">
                    <dt><?php _e( 'Woodfired garlic &amp; oregano flatbread with dips', 'mossco_hc' ); ?></dt>
                    <dd>
                        <?php _e( 'Basil pesto, black olive tapenade, sun dried tomato oi', 'mossco_hc' ); ?>
                    </dd>
                    <p class="allergen_info"><?php _e( '(10,4)', 'mossco_hc' ); ?></p>
                    <p class="price"><?php _e( '&euro;10.00', 'mossco_hc' ); ?></p>
                </div>
                <div class="menu_item">
                    <dt><?php _e( 'Spicy beef Mexican style soft tacos', 'mossco_hc' ); ?></dt>
                    <dd>
                        <?php _e( 'Black beans, guacamole, sour cream &amp; pickled red onion', 'mossco_hc' ); ?>
                    </dd>
                    <p class="allergen_info"><?php _e( '(2,4)', 'mossco_hc' ); ?></p>
                    <p class="price"><?php _e( '&euro;5.50', 'mossco_hc' ); ?></p>
                </div>
                <div class="menu_item">
                    <dt><?php _e( 'Chicken tika skewers', 'mossco_hc' ); ?></dt>
                    <dd>
                        <?php _e( 'Creamy peanut butter sauce, shaved cucumber, tomato &amp; coriander', 'mossco_hc' ); ?>
                    </dd>
                    <p class="allergen_info"><?php _e( '(2,5,10,4)', 'mossco_hc' ); ?></p>
                    <p class="price"><?php _e( '&euro;10.00', 'mossco_hc' ); ?></p>
                </div>
                <div class="menu_item">
                    <dt><?php _e( 'Sizzling garlic, chili, lemon &amp; parsley black tiger prawns', 'mossco_hc' ); ?></dt>
                    <dd>
                        <?php _e( 'Char grilled focaccia', 'mossco_hc' ); ?>
                    </dd>
                    <p class="allergen_info"><?php _e( '(1,2,9,10,4)', 'mossco_hc' ); ?></p>
                    <p class="price"><?php _e( '&euro;10.00', 'mossco_hc' ); ?></p>
                </div>
                <div class="menu_item">
                    <dt><?php _e( 'Oven baked Italian style meatballs', 'mossco_hc' ); ?></dt>
                    <dd>
                        <?php _e( 'roasted tomato sauce, buffalo mozzarella, fresh basil &amp; parmesan', 'mossco_hc' ); ?>
                    </dd>
                    <p class="allergen_info"><?php _e( '(1,2,9,10,4)', 'mossco_hc' ); ?></p>
                    <p class="price"><?php _e( '&euro;10.00', 'mossco_hc' ); ?></p>
                </div>
                <div class="menu_item">
                    <dt><?php _e( 'Moss.co sharing platter', 'mossco_hc' ); ?></dt>
                    <dd>
                        <?php _e( 'Crispy chicken wings, woodfired garlic &amp; oregano flatbread, spicy beef nachos,', 'mossco_hc' ); ?> 
                        <?php _e( '&amp; black tiger prawn skewers', 'mossco_hc' ); ?>
                    </dd>
                    <p class="allergen_info"><?php _e( '(1,2,9,10,4)', 'mossco_hc' ); ?></p>
                    <p class="price"><?php _e( '&euro;10.00', 'mossco_hc' ); ?></p>
                </div>
                <h4 class="border-b-2 border-primary-NORMAL border-solid mid my-6 pb-2 text-xl"><?php _e( 'Pasta', 'mossco_hc' ); ?></h4> 
                <div class="menu_item">
                    <dt><?php _e( 'Chicken &amp; chorizo penne', 'mossco_hc' ); ?></dt>
                    <dd>
                        <?php _e( 'Rocket, sundried tomato &amp; crème fraiche', 'mossco_hc' ); ?>
                    </dd>
                    <p class="allergen_info"><?php _e( '(2,10,11,4)', 'mossco_hc' ); ?></p>
                    <p class="price"><?php _e( '&euro;14.00', 'mossco_hc' ); ?></p>
                </div>
                <div class="menu_item">
                    <dt><?php _e( 'Wild mushroom penne', 'mossco_hc' ); ?></dt>
                    <dd>
                        <?php _e( 'Crispy cauliflower &amp; roast hazelnut pesto', 'mossco_hc' ); ?>
                    </dd>
                    <p class="allergen_info"><?php _e( '(1,2,10,4)', 'mossco_hc' ); ?></p>
                    <p class="price"><?php _e( '&euro;14.00', 'mossco_hc' ); ?></p>
                </div>
                <div class="menu_item">
                    <dt><?php _e( 'Black tiger prawn linguine', 'mossco_hc' ); ?> </dt>
                    <dd>
                        <?php _e( 'Courgettes, chili lemon &amp; rocket', 'mossco_hc' ); ?>
                    </dd>
                    <p class="allergen_info"><?php _e( '(10,4)', 'mossco_hc' ); ?></p>
                    <p class="price"><?php _e( '&euro;17.00', 'mossco_hc' ); ?></p>
                </div>
                <h4 class="border-b-2 border-primary-NORMAL border-solid mid my-6 pb-2 text-xl"><?php _e( 'Main Course', 'mossco_hc' ); ?></h4> 
                <div class="menu_item">
                    <dt><?php _e( 'Beer battered locally caught sustainable fish of the day', 'mossco_hc' ); ?></dt>
                    <dd>
                        <?php _e( 'House fries, pea, shallot and watercress puree, tartar sauce', 'mossco_hc' ); ?>
                    </dd>
                    <p class="allergen_info"><?php _e( '(2,10,11,4)', 'mossco_hc' ); ?></p>
                    <p class="price"><?php _e( '&euro;16.00', 'mossco_hc' ); ?></p>
                </div>
                <div class="menu_item">
                    <dt><?php _e( 'Thai green chicken curry', 'mossco_hc' ); ?></dt>
                    <dd>
                        <?php _e( 'Grilled lime &amp; Thai basil, fragrant jasmine rice', 'mossco_hc' ); ?>
                    </dd>
                    <p class="allergen_info"><?php _e( '(1,2,10,4)', 'mossco_hc' ); ?></p>
                    <p class="price"><?php _e( '&euro;19.00', 'mossco_hc' ); ?></p>
                </div>
                <div class="menu_item">
                    <dt><?php _e( 'Slow braised beef', 'mossco_hc' ); ?></dt>
                    <dd>
                        <?php _e( 'Root vegetables &amp; Guinness hot pot with a puff pastry topping, creamy champ potato', 'mossco_hc' ); ?>
                    </dd>
                    <p class="allergen_info"><?php _e( '(10,4)', 'mossco_hc' ); ?></p>
                    <p class="price"><?php _e( '&euro;22.00', 'mossco_hc' ); ?></p>
                </div>
                <div class="border-primary-NORMAL border-r-4 border-t-4 dark part2 pb-16 lg:pb-0 xl:pb-14 2xl:pb-12 rounded-xl md:my-0">
                    <h4 class="border-b-2 border-primary-NORMAL border-solid font-sans my-6 pb-3 text-Mossco-grey-semi text-xl uppercase"><?php _e( 'Sundaes', 'mossco_hc' ); ?></h4> 
                    <div class="menu_item">
                        <dt><?php _e( 'The brownie vanilla ice cream', 'mossco_hc' ); ?></dt>
                        <dd>
                            <?php _e( 'Warm brownie, hot chocolate sauce, whipped cream &amp; roasted pecans', 'mossco_hc' ); ?>
                        </dd>
                        <p class="allergen_info"><?php _e( '(2,10,11,4)', 'mossco_hc' ); ?></p>
                        <p class="price"><?php _e( '&euro;3.00', 'mossco_hc' ); ?></p>
                    </div>
                    <div class="menu_item">
                        <dt><?php _e( 'Strawberry shortbread', 'mossco_hc' ); ?></dt>
                        <dd>
                            <?php _e( 'Strawberry ice cream, crushed shortbread biscuits, strawberry syrup, macerated strawberries &amp; whipped cream pecans', 'mossco_hc' ); ?>
                        </dd>
                        <p class="allergen_info"><?php _e( '(1,2,10,4)', 'mossco_hc' ); ?></p>
                        <p class="price"><?php _e( '&euro;3.50', 'mossco_hc' ); ?></p>
                    </div>
                    <div class="menu_item">
                        <dt><?php _e( 'Crunchy peanut butter &amp; banoffee toffee', 'mossco_hc' ); ?></dt>
                        <dd>
                            <?php _e( 'Vanilla ice cream, peanut butter &amp; toffee sauce, banana &amp; crus', 'mossco_hc' ); ?>
                        </dd>
                        <p class="allergen_info"><?php _e( '(10,4)', 'mossco_hc' ); ?></p>
                        <p class="price"><?php _e( '&euro;2.50', 'mossco_hc' ); ?></p>
                    </div>
                    <h4 class="border-b-2 border-primary-NORMAL border-solid font-sans my-6 pb-3 text-Mossco-grey-semi text-xl uppercase"><?php _e( 'Desserts', 'mossco_hc' ); ?></h4>
                    <div class="menu_item">
                        <dt><?php _e( 'Cheesecake', 'mossco_hc' ); ?></dt>
                        <p class="allergen_info"><?php _e( '(4)', 'mossco_hc' ); ?></p>
                        <p class="price"><?php _e( '&euro;7.50', 'mossco_hc' ); ?></p>
                    </div>
                    <div class="menu_item">
                        <dt><?php _e( 'Warm apple crumble', 'mossco_hc' ); ?></dt>
                        <dd>
                            <?php _e( 'Vanilla ice cream &amp; crème anglaise', 'mossco_hc' ); ?>
                        </dd>
                        <p class="allergen_info"><?php _e( '(4)', 'mossco_hc' ); ?></p>
                        <p class="price"><?php _e( '&euro;7.50', 'mossco_hc' ); ?></p>
                    </div>
            ...
            <div class="col-span-1 mt-4 md:mt-4">
                <h4 class="border-b-2 border-primary-NORMAL border-solid font-sans my-6 pb-3 text-Mossco-grey-semi text-xl uppercase"><?php _e( 'Pizza', 'mossco_hc' ); ?></h4> 
                <div class="menu_item">
                    <dt><?php _e( 'Margherita', 'mossco_hc' ); ?></dt>
                    <dd>
                        <?php _e( 'Buffalo mozzarella, basil, parmesan, tomato sauce &amp; olive oil', 'mossco_hc' ); ?>
                    </dd>
                    <p class="allergen_info"><?php _e( '(2,10,11,4)', 'mossco_hc' ); ?></p>
                    <p class="price"><?php _e( '&euro;12.00', 'mossco_hc' ); ?></p>
                </div>
                <div class="menu_item">
                    <dt><?php _e( 'Pepperoni', 'mossco_hc' ); ?></dt>
                    <dd>
                        <?php _e( 'Spicy pepperoni, mozzarella &amp; tomato sauce', 'mossco_hc' ); ?>
                    </dd>
                    <p class="allergen_info"><?php _e( '(1,2,10,4)', 'mossco_hc' ); ?></p>
                    <p class="price"><?php _e( '&euro;14.00', 'mossco_hc' ); ?></p>
                </div>
                <div class="menu_item">
                    <dt><?php _e( 'Irlandese', 'mossco_hc' ); ?></dt>
                    <dd>
                        <?php _e( 'Clonakilty black pudding, bacon, mushroom, potato, tomato sauce, Hegarty cheddar &amp; buffalo mozzarella', 'mossco_hc' ); ?>
                    </dd>
                    <p class="allergen_info"><?php _e( '(10,4)', 'mossco_hc' ); ?></p>
                    <p class="price"><?php _e( '&euro;15.00', 'mossco_hc' ); ?></p>
                </div>
                <div class="menu_item">
                    <dt><?php _e( 'Parma', 'mossco_hc' ); ?></dt>
                    <dd>
                        <?php _e( 'Tomato sauce, Parma ham, artichoke, black olive, rocket &amp; parmesan shavings', 'mossco_hc' ); ?>
                    </dd>
                    <p class="allergen_info"><?php _e( '(2,4)', 'mossco_hc' ); ?></p>
                    <p class="price"><?php _e( '&euro;15.00', 'mossco_hc' ); ?></p>
                </div>
                <h4 class="border-b-2 border-primary-NORMAL border-solid font-sans my-6 pb-3 text-Mossco-grey-semi text-xl uppercase"><?php _e( 'Burgers', 'mossco_hc' ); ?></h4> 
                <div class="menu_item">
                    <dt><?php _e( 'Bacon &amp; cheese', 'mossco_hc' ); ?></dt>
                    <dd>
                        <?php _e( 'Brioche bun, crispy bacon, mature cheddar, buttercrunch lettuce, pickle &amp; burger sauce &amp; house fries', 'mossco_hc' ); ?>
                    </dd>
                    <p class="allergen_info"><?php _e( '(2,10,11,4)', 'mossco_hc' ); ?></p>
                    <p class="price"><?php _e( '&euro;14.00', 'mossco_hc' ); ?></p>
                </div>
                <div class="menu_item">
                    <dt><?php _e( 'Buttermilk chicken sandwich', 'mossco_hc' ); ?></dt>
                    <dd>
                        <?php _e( 'Soft brioche bun, pickles, buttercrunch lettuce, crispy bacon, siracha mayo &amp; house fries', 'mossco_hc' ); ?>
                    </dd>
                    <p class="allergen_info"><?php _e( '(1,2,10,4)', 'mossco_hc' ); ?></p>
                    <p class="price"><?php _e( '&euro;15.00', 'mossco_hc' ); ?></p>
                </div>
                <div class="menu_item">
                    <dt><?php _e( 'The falafel', 'mossco_hc' ); ?></dt>
                    <dd>
                        <?php _e( 'Brioche bun, spiced chickpea falafel, tomato salsa, guacamole, lettuce &amp; mayo served with house fries', 'mossco_hc' ); ?>
                    </dd>
                    <p class="allergen_info"><?php _e( '(10,4)', 'mossco_hc' ); ?></p>
                    <p class="price"><?php _e( '&euro;16.00', 'mossco_hc' ); ?></p>
                </div>
                <h4 class="border-b-2 border-primary-NORMAL border-solid font-sans my-6 pb-3 text-Mossco-grey-semi text-xl uppercase"><?php _e( 'Salads', 'mossco_hc' ); ?></h4> 
                <div class="menu_item">
                    <dt><?php _e( 'Classic caesar', 'mossco_hc' ); ?></dt>
                    <dd>
                        <?php _e( 'Crisp baby gem, creamy dressing, crispy bacon, soft boiled egg, croutons &amp; parmesan shavings', 'mossco_hc' ); ?>
                    </dd>
                    <p class="allergen_info"><?php _e( '(2,10,11,4)', 'mossco_hc' ); ?></p>
                    <p class="price"><?php _e( '&euro;12.00', 'mossco_hc' ); ?></p>
                </div>
                <div class="menu_item">
                    <dt><?php _e( 'Bulghur wheat grilled Mediterranean vegetables', 'mossco_hc' ); ?></dt>
                    <dd>
                        <?php _e( 'Olives, feta, mint &amp; flat parsley', 'mossco_hc' ); ?>
                    </dd>
                    <p class="allergen_info"><?php _e( '(1,2,10,4)', 'mossco_hc' ); ?></p>
                    <p class="price"><?php _e( '&euro;13.00', 'mossco_hc' ); ?></p>
                </div>
                <div class="menu_item">
                    <dt><?php _e( 'Superfood salad quinoa', 'mossco_hc' ); ?></dt>
                    <dd>
                        <?php _e( 'Grilled broccoli, red cabbage, walnuts, baby spinach, squash &amp; pomegranate with a citrus dressing', 'mossco_hc' ); ?>
                    </dd>
                    <p class="allergen_info"><?php _e( '(10,4)', 'mossco_hc' ); ?></p>
                    <p class="price"><?php _e( '&euro;14.00', 'mossco_hc' ); ?></p>
                </div>
                <div class="menu_item">
                    <dt><?php _e( 'Enhance your salad', 'mossco_hc' ); ?></dt>
                    <dd><i><?php _e( '- Grilled Garlic, lemon &amp; tarragon chicken skewers', 'mossco_hc' ); ?></i>
                    </dd>
                    <dd><i><?php _e( '- Grilled garlic &amp; chili black tiger prawn skewers', 'mossco_hc' ); ?></i>
                    </dd>
                    <dd><i><?php _e( '- Smoky BBQ glazed haloumi skewers', 'mossco_hc' ); ?></i>
                    </dd>
                    <p class="price"><?php _e( '&euro;2.00', 'mossco_hc' ); ?></p>
                </div>
                <div class="border-r-4 border-t-4 dark border-primary-NORMAL rounded-xl">
                    <h4 class="border-b-2 border-primary-NORMAL border-solid font-sans my-6 pb-3 text-Mossco-grey-semi text-xl uppercase"><?php _e( 'Sides', 'mossco_hc' ); ?></h4> 
                    <div class="menu_item">
                        <dt><?php _e( 'House fries', 'mossco_hc' ); ?></dt>
                        <p class="allergen_info"><?php _e( '(2,10,11,4)', 'mossco_hc' ); ?></p>
                        <p class="price"><?php _e( '&euro;3.00', 'mossco_hc' ); ?></p>
                    </div>
                    <div class="menu_item">
                        <dt><?php _e( 'Baby leaf salad', 'mossco_hc' ); ?></dt>
                        <dd>
                            <?php _e( 'Cherry tomato, red onion, cucumber with a French dressing', 'mossco_hc' ); ?>
                        </dd>
                        <p class="allergen_info"><?php _e( '(1,2,10,4)', 'mossco_hc' ); ?></p>
                        <p class="price"><?php _e( '&euro;3.50', 'mossco_hc' ); ?></p>
                    </div>
                    <div class="menu_item">
                        <dt><?php _e( 'Beer batter onion rings', 'mossco_hc' ); ?></dt>
                        <p class="allergen_info"><?php _e( '(10,4)', 'mossco_hc' ); ?></p>
                        <p class="price"><?php _e( '&euro;2.50', 'mossco_hc' ); ?></p>
                    </div>
                    <div class="menu_item">
                        <dt><?php _e( 'Sweet potato fries', 'mossco_hc' ); ?></dt>
                        <p class="allergen_info"><?php _e( '(4)', 'mossco_hc' ); ?></p>
                        <p class="price"><?php _e( '&euro;2.50', 'mossco_hc' ); ?></p>
                    </div>
                </div>
                <div data-empty-placeholder="" class="evening-menu-bg h-0 hidden md:flex md:h-1/5"></div>
            </div>
        </div>
    </section>
    <section id="download-menu" class="bottom-0 container flex items-center justify-center max-w-screen-xl ml-auto mx-auto px-4 rounded-md sticky xl:pr-2 2xl:pr-0" data-pg-ia-scene="{&quot;l&quot;:[{&quot;t&quot;:&quot;#gt# div:nth-of-type(1) #gt# div:nth-of-type(2)&quot;,&quot;p&quot;:&quot;time&quot;,&quot;a&quot;:{&quot;l&quot;:[{&quot;t&quot;:&quot;&quot;,&quot;l&quot;:[{&quot;t&quot;:&quot;set&quot;,&quot;p&quot;:1.3,&quot;d&quot;:0,&quot;l&quot;:{&quot;autoAlpha&quot;:0,&quot;y&quot;:&quot;100%&quot;},&quot;e&quot;:&quot;Power1.easeOut&quot;},{&quot;t&quot;:&quot;tween&quot;,&quot;p&quot;:1.3,&quot;d&quot;:0.5,&quot;l&quot;:{&quot;autoAlpha&quot;:1,&quot;y&quot;:&quot;0%&quot;},&quot;e&quot;:&quot;Power1.easeOut&quot;}]}]}}]}">
        <div class="container flex grid grid-cols-1 items-end justify-end px-0 sm:grid-cols-1 md:grid-cols-2 md:px-4 lg:grid-cols-3 lg:justify-center lg:px-4 xl:justify-center xl:px-5 2xl:justify-center 2xl:px-6">
            ...
            <div class="bg-Mossco-grey-dark bg-opacity-25 col-span-1 flex h-full items-center justify-center my-auto py-6 rounded-sm md:py-8" data-pg-ia-hide><a class="active:bg-primary-DARK active:border-primary-DARK bg-opacity-50 bg-primary-NORMAL border-2 border-primary-NORMAL border-solid bottom-0 cursor-pointer drop-shadow duration-300 ease-out flex font-sans hover:bg-primary-LIGHT hover:border-primary-LIGHT hover:drop-shadow-xl hover:ring hover:ring-primary-DARK hover:rounded-sm hover:text-white items-center justify-center px-8 py-2 rounded uppercase w-60 lg:font-medium 2xl:bg-primary-NORMAL"> <?php _e( 'Download Menu', 'mossco_hc' ); ?> <svg class="fill-current h-6 ml-2 my-auto w-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" fill="currentColor">

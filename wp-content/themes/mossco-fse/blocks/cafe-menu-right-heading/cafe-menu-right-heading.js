...
( function ( blocks, element, blockEditor ) {
    ...
    const block = registerBlockType( 'mossco-fse/cafe-menu-right-heading', {
        apiVersion: 2,
        title: 'Menu Right Heading',
        description: '',
        icon: 'block-default',

...
( function ( blocks, element, blockEditor ) {
    ...
    const block = registerBlockType( 'mossco-fse/mo-home-navigation-v2', {
        apiVersion: 2,
        title: 'Home Navigation Block v2',
        description: '',
        ...
        example: { attributes: { mo_logo: {id: 0, url: (pg_project_data_mossco_fse ? pg_project_data_mossco_fse.url : '') + 'assets/images/logo/logo-white-teal.svg', size: '', svg: '', alt: null}, mo_nav_button_link: {post_id: 0, url: '#', title: '', 'post_type': null}, mo_nav_button_text: `Book a Table` } },
        edit: function ( props ) {
            const blockProps = useBlockProps({ className: 'h-28 scroll-smooth smooth-scrolling sticky top-0 z-50 sm:h-28', 'data-pg-ia-scene': '{"l":[{"name":"logo","t":"img","a":{"l":[{"t":"","l":[{"t":"set","p":0,"d":0,"l":{"autoAlpha":0},"e":"Power1.easeOut"},{"t":"tween","p":0,"d":0.5,"l":{"autoAlpha":1},"e":"Power1.easeOut"}]}]},"p":"time","s":"0"},{"t":"nav #gt# div","a":{"l":[{"t":"","l":[{"t":"set","p":0.5,"d":0,"l":{"autoAlpha":0},"e":"Power1.easeOut"},{"t":"tween","p":0.5,"d":0.5,"l":{"autoAlpha":1},"e":"Power1.easeOut"}]}]},"p":"time","s":"0"},{"name":"burger menu","t":"button","a":{"l":[{"t":"","l":[{"t":"set","p":0,"d":0,"l":{"autoAlpha":0},"e":"Power1.easeOut"},{"t":"tween","p":0.5,"d":0.5,"l":{"autoAlpha":1},"e":"Power1.easeOut"}]}]},"p":"time","s":"0%"},{"name":"book table button tablet","t":"nav #gt# a:nth-of-type(2)","a":{"l":[{"t":"","l":[{"t":"set","p":0,"d":0,"l":{"autoAlpha":0},"e":"Power1.easeOut"},{"t":"tween","p":0.5,"d":0.5,"l":{"autoAlpha":1},"e":"Power1.easeOut"}]}]},"p":"time"}]}', 'data-pgc': 'mossco.navigation', 'data-pgc-no-update': null, 'data-pg-name': 'Mossco Header' });
            const setAttributes = props.setAttributes; 
            
            props.mo_logo = useSelect(function( select ) {
                return {
                    mo_logo: props.attributes.mo_logo.id ? select('core').getMedia(props.attributes.mo_logo.id) : undefined
                };
            }, [props.attributes.mo_logo] ).mo_logo;
            ...
            return el(Fragment, {}, [
                        ...
                        el( ServerSideRender, {
                            block: 'mossco-fse/mo-home-navigation-v2',
                            httpMethod: 'POST',
                    ...
                    el( InspectorControls, {},
                        ...
                        pgMediaImageControl('mo_logo', setAttributes, props, 'full', true, 'mo_logo', '' ),
